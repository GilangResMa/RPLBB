/* filepath: path/to/your/script.js */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('persons').addEventListener('change', calculatePrice);
});
...
function calculatePrice() {
    ...
    if (checkinDate && checkoutDate && checkoutDate > checkinDate) {
        ...
        document.getElementById('nights-info').textContent = `${nights} malam × ${persons} orang`;
